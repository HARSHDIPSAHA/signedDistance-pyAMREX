...
def test_3d_visualization():
    ...
    try:
        ...
        print(f"✅ Sampled sphere: shape={phi.shape}, min={phi.min():.3f}, max={phi.max():.3f}")
        ...
        print(f"✅ Created visualization with uniform bounds")
        ...
        print(f"✅ Created visualization with per-axis bounds")
        ...
        print(f"✅ Created visualization for combined geometry")
...
def test_2d_visualization():
    ...
    try:
        ...
        assert os.path.exists(output_file3), f"Output file not created: {output_file3}"
        print(f"✅ Created 2D visualization for combined geometry")
...
def test_error_handling():
    ...
    try:
        ...
        from sdf2d import save_levelset_html_2d
